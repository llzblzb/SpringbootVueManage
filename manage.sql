...
CREATE TABLE `course`  (
  ...
  `score` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '学分',
...
CREATE TABLE `sys_file`  (
  ...
  `md5` varchar(150) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '文件md5',
  PRIMARY KEY (`id`) USING BTREE
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '角色菜单禁用表' ROW_FORMAT = Compact;
...
CREATE TABLE `sys_user`  (
  ...
  `role` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT 'ROLE_USER' COMMENT '角色',
  PRIMARY KEY (`id`) USING BTREE,
